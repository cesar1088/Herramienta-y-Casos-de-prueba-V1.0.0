/*-----------------------------------------------------------------------------
| Caso de Prueba #4: "Generación de Variables Aleatorias Continuas" (A3)(FLOAT)|
...
@WebService()
public class A3_FContinuas
{
    @WebMethod(operationName = "peticionContinuasFA3")
    ...
    private void imprime(float[] valores)
    {
