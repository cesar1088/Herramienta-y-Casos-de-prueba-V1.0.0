/*-----------------------------------------------------------------------------
| Caso de Prueba #5: "Generación de Variables Aleatorias Discretas"(A3)(DOUBLE)|
...
@WebService()
public class A3_DDiscretas
{
    @WebMethod(operationName = "peticionDiscretasDA3")
    public double peticionDiscretasDA3(@WebParam(name = "repeticiones")
    int repeticiones)
    {
