/*-----------------------------------------------------------------------------
| Caso de Prueba #5: "Generación de Variables Aleatorias Discretas"(A4)(DOUBLE)|
...
@WebService()
public class A4_DDiscretas
{
    @WebMethod(operationName = "peticionDiscretasDA4")
    public double peticionDiscretasDA4(@WebParam(name = "repeticiones")
    int repeticiones)
    {
        ...
        try
        {
            ...
            im.imprime(new BinomialNegativo().calcular(repeticiones));
            ...
            im.imprime(new HiperGeometrica().calcular(repeticiones));
